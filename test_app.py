...
class BloglyTestCase(TestCase):
    ...
    def test_user_page(self):
        ...
        with self.client as client:
            user_id = User.find_user_id("This is", "a stupid test").id
            print(f"\n\n\n\n\n\n\n\n\n\n\n\nTEST USER PAGE")
    ...
    #         html = response.get_data(as_text=True)
    #         self.assertEqual(response.status_code, 200)
    #         self.assertIn("Add Post for This is2 a stupid test2", html)
    ...
    #     with self.client as client:
    #         user_id = User.find_user_id("This is2", "a stupid test2").id
